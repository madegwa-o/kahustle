...
export default function ConstructionServiceGallery({ images }: { images: string[] }) {
  ...
  return (
      <div className="space-y-2">
        <div className="relative overflow-hidden rounded-xl bg-muted aspect-[16/9]">
          <img src={images[active]} alt={`Construction service image ${active + 1}`} className="h-full w-full object-cover" />
          {images.length > 1 && (
              <>
