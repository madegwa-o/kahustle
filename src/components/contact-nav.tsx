...
import {MapPin, Phone, Mail, Sun, Moon, Menu} from "lucide-react"
        ...
        <div className="w-full bg-[#1a7a3c] text-white text-xs">
            ...
            <div className="max-w-7xl mx-auto px-4 h-9 flex items-center justify-between">
                ...
                <button
                    ...
                    className="text-primary-foreground/80 hover:text-primary-foreground transition-colors shrink-0"
                >
                ...
                className="hidden sm:flex items-center gap-1.5 text-primary-foreground/80 hover:text-primary-foreground transition-colors"
                >
